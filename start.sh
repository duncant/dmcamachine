...
# Run the container
docker run -d -v $TMP_TORRENT_DOWNLOAD_DIR:/dmca/static/torrents_tmp -v $TMP_HTTP_DOWNLOAD_DIR:/dmca/static/htp_tmp -v $DOWNLOAD_DIR:/dmca/static/torrents -p $HSTIP:$PRT:80 -it --rm --name dmcarunning dmcamachine
